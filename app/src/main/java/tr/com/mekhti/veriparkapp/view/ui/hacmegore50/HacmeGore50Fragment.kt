package tr.com.mekhti.veriparkapp.view.ui.hacmegore50
...
class HacmeGore50Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.getStocks(Constants.VOLUME50)
    ...
    private fun textWatcher() {
        mView.editTextFilter.doOnTextChanged { text, _, _, _ ->
            if (mStocks.stocks.isNotEmpty()){
                val filteredStocks = mStocks.stocks.filter {
                    DecEncAes.decrypt(it.symbol.toByteArray())
